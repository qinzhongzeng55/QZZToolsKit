...
- (void)layoutSubviews {
    ...
    CGFloat maxH = [[UIScreen mainScreen] bounds].size.height - 100;
    ...
    CGSize labelSize = [[AutomaticSizeTools sharedAutomaticSizeTools] calculateSizeForLabel:label MaxWidth:maxWidth LineSpacing:5 WordsSpacing:0.5 textAlignment:MBLabelAlignmentCenter];
    labelSize.width = MIN(labelSize.width, maxWidth);
    totalSize.width = MAX(totalSize.width, labelSize.width);
    if (labelSize.height > maxH-100){
        labelSize.height = maxH-100;
    }
